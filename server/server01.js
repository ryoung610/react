...
const { PAYPAL_CLIENT_ID, PAYPAL_SECRET_ID, PORT = 8888 } = process.env;
console.log("PayPal Client ID:", PAYPAL_CLIENT_ID);
console.log("PayPal Client Secret:", PAYPAL_SECRET_ID);
...
const generateAccessToken = async () => {
  ...
  try {
    ...
    console.log("Client Secret:", PAYPAL_SECRET_ID);
...
app.post("/api/orders", async (req, res) => {
  try {
    ...
    console.log("Capturing cart order: - ", cart);
